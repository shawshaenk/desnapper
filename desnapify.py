...
def purge_snaps():
    ...
    desnap_or_not = input(f"WARNING: THE FOLLOWING SNAP PACKAGES AND THEIR DATA WILL BE REMOVED: {data.stdout} \n DO YOU WANT TO CONTINUE? Y/N: ")

    if desnap_or_not.lower() == 'y':
...
def install_flatpak():
    ...
    if install_flatpak_or_not.lower() == 'y':
